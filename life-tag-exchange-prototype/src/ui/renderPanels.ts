...
const PHASE_COPY: Partial<Record<RunPhase, PhasePanelCopy>> = {
  [RunPhase.RunInit]: {
    ...
    placeholder: 'P0-2 将初始化 RunState、DayState 与 DeckState。',
  },
  [RunPhase.DayOpening]: {
    title: '开店阶段',
    description: '阅读今日市场新闻。市场新闻生成将在后续阶段实现。',
    placeholder: 'P0-2 暂不生成市场新闻。',
  },
  [RunPhase.DayPurchase]: {
    title: '进货阶段',
    description: '商品候选生成与买入将在后续阶段实现。',
    placeholder: 'P0-2 暂无商品候选。',
  },
  [RunPhase.DayCustomer]: {
    title: '接单阶段',
    description: '顾客订单生成将在后续阶段实现。',
    placeholder: 'P0-2 暂无顾客订单。',
  },
  [RunPhase.DayDraw]: {
    title: '抽牌阶段',
    description: '抽牌系统将在后续阶段实现。',
    placeholder: 'P0-2 不抽牌，只显示牌堆数量。',
  },
  [RunPhase.DayProcess]: {
    title: '处理阶段',
    description: '基础操作、卡牌和交易预览将在后续阶段实现。',
    placeholder: 'P0-2 暂无可执行处理操作。',
  },
  [RunPhase.DaySell]: {
    title: '出售阶段',
    description: '出售与结算将在后续阶段实现。',
    placeholder: 'P0-2 暂无可出售交易。',
  },
  [RunPhase.DayResolve]: {
    title: '结算阶段',
    description: '日结摘要将在后续阶段实现。',
    placeholder: 'P0-2 暂无真实结算。',
  },
  [RunPhase.DayReward]: {
    title: '收店阶段',
    description: '三选一奖励将在后续阶段实现。',
    placeholder: 'P0-2 暂不选择奖励，点击进入下一天。',
  },
  [RunPhase.RunEnd]: {
    title: '本局结束',
    description: 'P0-2 占位最终报告。正式胜负判定和经营报告将在后续阶段实现。',
    placeholder: '正式胜负判定将在后续阶段实现。',
  },
  [RunPhase.RunFailed]: {
    title: '本局失败',
    description: '失败状态占位。P0-2 不主动制造失败。',
